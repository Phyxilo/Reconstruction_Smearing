...
void MultipVTX()
{
  TFile *monteCarlo = TFile::Open("/home/phyxilo/root/macros/Smearing/Vertexing/ImpactParameter/vertexingTrReducedMC_10.root");
  ...
  TFile outFile("vertexingMultipMC_10.root","recreate");
